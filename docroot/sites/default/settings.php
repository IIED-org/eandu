 ...
 *
 */
$drupal_hash_salt = 'Y-tl0AXzXuuGrrMtkQR8UbBxpqeMwPgA60DpeX3n3xU';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_eandu_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_eandu_dev_default.inc';
}
// </DDSETTINGS>
